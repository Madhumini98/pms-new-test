...
if ($result1) {
    ...
    $isEnable = ($row1['mode'] === 't') ? 'disable' : 'enable';
} else {
...
// Now, $isEnable contains the value 'enable' or 'disable' based on the 'mode' column
...
$folderPath = 'bills/slt'; // Bills folder path
...
<?php
if($paymentOptionEnabled=='enable'){
  ?> 
            <div class="items-center justify-between py-5 lg:py-6">
...
<script>
      new gridjs.Grid({
        ...
        columns: [
          ...
          {
            name: "Download",
            formatter: (_, row) => gridjs.html(`<a href="bills/slt/${row.cells[0].data}" download>Download</a>`)
          }
        ],
        search: true,
        sort: true,
