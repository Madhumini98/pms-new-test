...
<!--                          Company Name -->
          ...
          <div class="card">
            ...
            <div class="space-y-4 p-4 sm:p-5">
              <form action="add.php" method="post">
               ...
               <!--get spot class using ipms-clients database.-->
                <div>
                <?php
    ...
    <script>
       // const spotIdInput = document.getElementById('spotid-input');
        //const spotIdRegex = /^[A-Z]\d{4}$/;

        spotIdInput.addEventListener('input', function() {
            const spotIdValue = spotIdInput.value;

            if (!spotIdRegex.test(spotIdValue)) {
                spotIdInput.setCustomValidity('Invalid spot ID format');
            } else {
                spotIdInput.setCustomValidity('');
            }
        });
