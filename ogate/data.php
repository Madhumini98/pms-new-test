...
$vehicle = $data[0][0];
$_SESSION['vehicle_For_QR'] = $vehicle;
...
$sql2 = "SELECT `info` FROM `signals` WHERE `id`='$vehicle'";
$result2 = mysqli_query($link, $sql2);
$num_rows2 = mysqli_num_rows($result2);
$data2 = mysqli_fetch_all($result2);
if ($num_rows2 == 1){
    if ($data2[0][0] == "online"){
        // rederection to the qr code page
        header("Location: http://165.227.144.188/pms-new/ogate/qrpayment.php");
        exit();
    }
...
if ($num_rows == 1){
    ...
    <body>
        ...
        echo $data[0][2];
        echo ' Hours</p>
        <p id="msg"><b>You can pay cash or online. </b></p>
    </body>
    </html>
