  ...
  <div id="root" class="min-h-100vh flex grow bg-slate-50 dark:bg-navy-900" x-cloak="">
    ...
    <div class="sidebar print:hidden">
      ...
      <div class="main-sidebar">
        <div class="flex h-full w-full flex-col items-center border-r border-slate-150 bg-navy-800 dark:border-navy-800 dark:border-navy-700 dark:bg-navy-800">
          <!-- Application Logo -->
          <div class="flex pt-4">
            <a href="index.php">
          ...
          <div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
            ...
            <!-- Add new Accounts -->
            <a href="addnew.php" class="flex h-11 w-11 items-center justify-center rounded-lg bg-primary/10 text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-navy-600 dark:text-accent-light dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90" x-tooltip.placement.right="'Add New Accounts'">
    ...
    <main @click="$store.global.isSidebarExpanded = false" class="main-content w-full px-[var(--margin-x)] pb-8">
      <div class="py-3 text-center lg:py-3">
          ...
          <div class="space-y-4 p-4 sm:p-5">
            <form class="user" action="add.php" method="post" enctype="multipart/form-data">
              ...
              if (isset($_GET['vehicle'])) {
                $number = $_GET['vehicle'];
                echo '<div class="mb-3"><input id="spotid-input" class="form-input w-full placeholder:text-center text-center rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" type="text" name="vehicleID" placeholder="Vehicle Number" required="" value="' . $number . '"></div>';
              } else {
                echo '<div class="mb-3"><input id="spotid-input" class="form-input w-full placeholder:text-center text-center rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" type="text" name="vehicleID" placeholder="Vehicle Number" required=""></div>';
              }
              ?>

              <div class="mb-3">
                <select id="spotid-input" name="type" class="form-select w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" style="text-align: center; color: rgb(148 163 184); opacity: .7;">
              ...
              if ($result && mysqli_num_rows($result) > 0) {
                ...
                echo '<div class="mb-3"><select id="spotid-input" name="class" class="form-select w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" style="text-align: center; color: rgb(148 163 184); opacity: .7;">';
              ...
              <div class="mb-3"><input id="spotid-input" name="owner" class="form-input w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" type="text" placeholder="Owner Name" required="" style="text-align: center;"></div>
              <div class="mb-3"><input id="spotid-input" name="nic" class="form-input w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" type="text" placeholder="NIC Number" required="" style="text-align: center;"></div>
              <div class="mb-3">
                <input id="spotid-input" required name="phone" class="form-input w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" type="tel" placeholder="07XXXXXXXX" style="text-align: center;">
              </div>
              <div class="mb-3">
                <input id="spotid-input" required class="form-input w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" type="file" style="text-align: center;" name="uploaded_file" value="Vehicle front image.">
              </div>

              <?php
              if (isset($_GET['vehicle'])) {
                $number = $_GET['vehicle'];
                echo '<div class="row mb-3"><a href="images/notRegister/' . $_SESSION['client'] . '/' . $number . '.jpg" download="">Download Your Image</a></div>';
              }
              ?>
              <div class="row mb-3">
              ...
              <button class="btn w-full bg-primary font-medium text-white custom-hover" id="submitBtn" type="submit">Register Vehicle</button>
              <hr>
            </form>
          </div>
...
//         echo '<script>swal("Success", "New user add success.", "success");</script>';
...
//         echo '<script>swal("Error", "Username Already exit.", "error");</script>';
