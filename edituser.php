<?php
session_start();
if (!isset($_GET['uname']) || !isset($_GET['role'])) {
        ...
        <div class="flex w-full items-center justify-between">
          ...
          <div class="-mr-1.5 flex items-center space-x-2">
            ...
            <button @click="$store.global.isDarkModeEnabled = !$store.global.isDarkModeEnabled" class="btn h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
              <svg x-show="$store.global.isDarkModeEnabled" x-transition:enter="transition-transform duration-200 ease-out absolute origin-top" x-transition:enter-start="scale-75" x-transition:enter-end="scale-100 static" class="h-6 w-6 text-amber-400" fill="none" viewbox="0 0 24 24">
                <path fill="#64748B" d="M11.75 3.412a.818.818 0 01-.07.917 6.332 6.332 0 00-1.4 3.971c0 3.564 2.98 6.494 6.706 6.494a6.86 6.86 0 002.856-.617.818.818 0 011.1 1.047C19.593 18.614 16.218 21 12.283 21 7.18 21 3 16.973 3 11.956c0-4.563 3.46-8.31 7.925-8.948a.818.818 0 01.826.404z"></path>
              </svg>
              <svg xmlns="http://www.w3.org/2000/svg" x-show="!$store.global.isDarkModeEnabled" x-transition:enter="transition-transform duration-200 ease-out absolute origin-top" x-transition:enter-start="scale-75" x-transition:enter-end="scale-100 static" class="h-6 w-6 text-amber-400" viewbox="0 0 20 20" fill="#64748B">
          ...
          <div class="border-b border-slate-200 p-4 dark:border-navy-500 sm:px-5">
            <div class="flex items-center space-x-2">
              ...
              <h4 class="text-lg font-medium text-slate-700 dark:text-navy-100">
                You are trying to edit {User Name : <b> <?php echo $_GET['uname']; ?> </b> and role : <b><?php echo $_GET['role']; ?></b>} Password be sure all data correct.
              </h4>
            </div>
          </div>
          <div class="space-y-4 p-4 sm:p-5">
            <form action="edit.php?id=spot" method="post">
              <label class="block">
                <span>User Name : <?php echo $_GET['uname']; ?></span>
                <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" type="text" name="uname" value="<?php echo $_GET['uname']; ?>" required hidden />
              </label>
              <br>
              <label class="block">
                <span>Spot Type.</span>
                <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="abcd123!" type="text" name="pass" required />
              </label>
              <br>
              <br>
              <div class="flex justify-center space-x-2" bis_skin_checked="1">
                <button type="reset" class="btn min-w-[7rem] rounded-full border border-slate-300 font-medium text-slate-700 hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80 dark:border-navy-450 dark:text-navy-100 dark:hover:bg-navy-500 dark:focus:bg-navy-500 dark:active:bg-navy-500/90">
                  <a href="parking_spots.php">Cancel </a>
                </button>
