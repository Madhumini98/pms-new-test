            ...
            <div class="form-container">
              ...
              <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="vehicleNumber" name="vehicleNumber" placeholder="ABxxxx">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group" id="spotIdContainer">
                      <label for="entered_spot">Spot ID</label>
...
if ($_SESSION['manual_add'] == 'Spot Not Available') {
  echo '<script>swal("Error", "Spot Not Available.", "error");</script>';

}

if ($_SESSION['manual_add'] == 'Spot Does Not Exist') {
  echo '<script>swal("Error", "Spot Does Not Exist.", "error");</script>';
