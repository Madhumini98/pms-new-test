            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter: (_, row) =>
                        gridjs.html(
                        <div class="flex">
                            <a href="editspot.php?spotid=${row.cells[0].data}&class=${row.cells[3].data}&type=${row.cells[2].data}" target="_blank">
                                <button type="button" class="btn btn-secondary">
                                    <i class="fas fa-edit"></i>
                            </button>
                            </a>
                            <a href="vehicledelete.php?id=${row.cells[0].data}" target="_blank">
