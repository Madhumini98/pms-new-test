...
//       $this->SetX(78);
//       $this->SetFont('helvetica', 'I', 8);
//       $this->Cell(0, 10, '© Copyright © 2023 iPMS. All rights reserved ' , 0, 0);
...
//           $currentRow++;
//       // } else {
//       //     // Move to the next page if the maximum rows are reached
//          // $pdf->AddPage();
//       //     Reset row counter
//           //$currentRow = 0;
//       //     // Output header again for the new page
//       //$pdf->SetX($tableX);
//       //     $pdf->SetFont('times', 'B', 11);
//       //     $pdf->SetTextColor(0, 0, 0);
//       //     $pdf->Cell(40, 10, 'TIME', 1);
...
?>
            ...
            <div class="items-center justify-between py-5 lg:py-6">
              <h1 class="text-3xl text-primary dark:text-accent-light" style="text-align: center;">Vehicle Bills Gallery</h1>
            </div>
            ...
            <div class="items-center justify-between py-5 lg:py-6">
              <h1 class="text-3xl text-primary dark:text-accent-light" style="text-align: center;">Vehicle Bills Gallery for Manual Entry</h1>
            </div>
