<?php
session_start();
if (!isset($_GET['spotid']) || !isset($_GET['class']) || !isset($_GET['type'])){
          ...
          <div class="card">
            ...
            <div class="space-y-4 p-4 sm:p-5">
              <form action="edit.php?id=spot" method="post">
                <label class="block">
                  <span>Spot ID : <?php echo $_GET['spotid']; ?></span>
                  <input
                          class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                          placeholder="A0001"
                          type="text"
                          name="spotid"
                          value="<?php echo $_GET['spotid']; ?>"
                          required
                          hidden
                  />
                </label>
                ...
                <label class="block">
                  ...
                  >
                    <option value="n" <?php if ($_GET['type'] == 'n'){
                        echo 'selected';
                    } ?> >Normal</option>
                    <option value="l" <?php if ($_GET['type'] == 'l'){
                        echo 'selected';
                    } ?>>Long</option>
                  </select>
                </label>
