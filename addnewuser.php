        ...
        <div class="card">
          ...
          <div class="space-y-4 p-4 sm:p-5">
            <form action="add.php" method="post">
              <label class="block">
                <span>Username:</span>
                <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Alen" type="text" name="username" required />
              </label>
              <br>
              <label class="block">
                <span>Role.</span>
                <select name="role" required class="form-select mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent">
                  ...
                  <option value="ig">In Gate</option>
                  <option value="og">Out Gate</option>
                  <option value="igs">In Gate Security</option>
                  <option value="ogs">Out Gate Security</option>
              ...
              <label class="block">
                <span>Password:</span>
                <input name="password" class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pr-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Password" type="text" />
              </label>
              <br>
