...
//For the new requirements get total spot using first letter of spot_id
// Fetch all rows from the 'spot' table
                ...
                <template x-teleport="#x-teleport-target">
                    ...
                    >
                        ...
                        <div
                                ...
                                x-transition:leave-end="opacity-0"
                        >
                        <svg xmlns="http://www.w3.org/2000/svg" class="inline h-28 w-28 text-yellow-500" viewBox="0 0 24 24" stroke="currentColor">
    <!-- Triangle shape for the warning sign with no fill (only border) -->
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" fill="none" d="M12 2L2 22h20L12 2zm0 15.5v-3M12 16v-2"/>
    <!-- Circle shape at the bottom of the warning sign -->
    <circle cx="12" cy="19" r="1.5" fill="currentColor" stroke="none"/>
                            ...
                            <div class="mt-4">
                                <h2 class="text-2xl text-slate-700 dark:text-navy-100">
                                    Are you sure you want to delete : <?php echo $_GET['id']; ?>
                                </h2>
                                <a href="parking_spots.php" > <button
                                ...
                                <a href="delete-spot-conf.php?id=<?php echo $_GET['id']; ?>"> <button
                                        @click="showModal = false"
                                        class="btn mt-6 bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90"
                                >
                                    Delete
        ...
        new gridjs.Grid({
            columns: [
                ...
                },
                {
                    ...
                    formatter: (_, row) =>
                        gridjs.html(
                            `<a href="editspot.php?spotid=${row.cells[0].data}&class=${row.cells[3].data}&type=${row.cells[2].data}" target="_blank"> <button type="button" class="btn btn-secondary">
