          ...
          <div class="space-y-4 p-4 sm:p-5">
            <form action="add.php" method="post">
              <label class="block">
                ...
                <input id="spotid-input" class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="SLT" type="text" name="client" required />
              </label>
              <br>
              <label class="block">
                <span>Mail:</span>
                <input id="spotid-input" class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="slt@slt.lk" type="email" name="mail" required />
              </label>
              <br>
              <label class="block">
                <span>Telephone No:</span>
                <input type="tel" class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" id="phone" name="phone" pattern="\+94\d{2}\s?\d{3}\s?\d{4}" placeholder="+94 XX XXX XXXX" required>

              </label>
              <br>
              <label class="block">
                <span>Super Admin Account Data:</span>
                <span>User Name:</span>
                <input id="spotid-input" class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="SLT" type="text" name="uname" required />
              </label>
              <br>
              <label class="block">
                <span>Password:</span>
                <input id="spotid-input" class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="SLT" type="text" name="pass" required />
              </label>
              <br>
              <label class="block">
                <span>Available Classes:</span>
                <input id="spotid-input" class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="A,B,C" type="text" name="A_class" required />
              </label>
              <br>
              <label class="block mt-4">
                ...
                <div class="mt-2">
                  <label class="inline-flex items-center">
                    <input type="radio" name="is_public" value="Yes" style="width: 20px; height: 20px;" />
                    <span class="ml-2" style="padding-left: 8px;">Yes</span>
                  </label>
                  <label class="inline-flex items-center ml-6">
                    <input type="radio" name="is_public" value="No" style="width: 20px; height: 20px;" />
                    <span class="ml-2" style="padding-left: 8px;">No</span>
                  </label>
                </div>
              </label>
              <br>
