      ...
      <main @click="$store.global.isSidebarExpanded = false" class="main-content w-full px-[var(--margin-x)] pb-8">
            ...
            <!-- <div class="items-center justify-between py-5 lg:py-6">
                ...
                <template x-teleport="#x-teleport-target">
                    <div
                            class="fixed inset-0 z-[100] flex flex-col items-center justify-center overflow-hidden px-4 py-6 sm:px-5 border border-gray-300 rounded-lg"
                            x-show="showModal"
                            role="dialog"
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="mt-4">
                                ...
                                <a href="delete_company.php?id=<?php echo $_GET['id']; ?>"> <button
                                        @click="showModal = false"
                                        class="btn mt-6 bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90"
                                >
                                    Delete
