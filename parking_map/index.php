...
<!--                          Company Name -->
      ...
      <nav class="header print:hidden">
       ...
       <main @click="$store.global.isSidebarExpanded = false" class="main-content w-full px-[var(--margin-x)] pb-8">
              <section style="padding-top: 5%;"> 
                  ...
                  <div class="map" style="color: #64748b;">
                    <?php
    ...
    <script>
        ...
        function displayStoredVehicleDetails() {
          ...
          // Check if the page was referred from another page
            var referringPage = document.referrer;

        // Add your condition to check if it's the expected referring page
        if (!(referringPage.includes('parking_map'))) {
            // Remove stored vehicle details only if referred from the expected page
        ...
        // // Check if the page is being unloaded (e.g., user navigating to another page)
        // window.addEventListener("beforeunload", function () {
        //     // Remove stored vehicle details from localStorage
        //     localStorage.removeItem('selectedVehicle');
        // });
