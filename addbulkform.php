...
<head>
  ...
  <title>Park'N Pay - Register Bulk Vehicle</title>
...
<body x-data="" class="is-header-blur" x-bind="$store.global.documentBody">
  ...
  <div id="root" class="min-h-100vh flex grow bg-slate-50 dark:bg-navy-900" x-cloak="">
    ...
    <div class="sidebar print:hidden">
      ...
      <div class="main-sidebar">
        <div class="flex h-full w-full flex-col items-center border-r border-slate-150 bg-navy-800 dark:border-navy-700 dark:bg-navy-800">
          <!-- Application Logo -->
          <div class="flex pt-4">
            <a href="index.php">
  ...
  <main @click="$store.global.isSidebarExpanded = false" class="main-content w-full place-items-center px-[var(--margin-x)] pb-12" style="bg-color: #f8fafc;">
    <div class="items-center justify-between py-5 lg:py-6">
      <h1 class="text-3xl text-primary dark:text-accent-light" style="text-align: center;">Register Bulk Vehicles (Note : No Any Duplicate Vehicle Numbers In CSV.)</h1>
    </div>
    <div class="text-center w-100" style="position: absolute;top: 200px; margin-left: 70px;">


      <div class="col-sm-12 col-lg-10 col-xl-9 col-xxl-7 dark:bg-navy-700 shadow-lg" style="border-radius: 5px;width: 90%;">
        <div class="p-5">
          <form class="user" action="bulkadd.php" method="post" enctype="multipart/form-data">
            <div class="mb-3">
              <label style="font-size: x-large;">Select CSV File</label>
            ...
            <div class="row mb-3"><a href="csv/template_vehicle.csv" download="">Download CSV Format</a></div>
            <button class="btn mt-8 bg-primary font-medium text-white shadow-lg shadow-primary/50 hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:shadow-accent/50 dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90" id="submitBtn" type="submit">Register All Vehicle</button>
            <hr>
          </form>
        </div>
      </div>
