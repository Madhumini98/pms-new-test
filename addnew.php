...
<!--                          Company Name -->
      ...
      <main @click="$store.global.isSidebarExpanded = false" class="main-content w-full place-items-center px-[var(--margin-x)] pb-12">
        <div class="py-5 text-center lg:py-6">
          <h3 class="mt-1 text-xl font-semibold text-slate-600 dark:text-navy-100">
            Welcome to 'Add New' Page
          </h3>
        </div>
        <div class="grid max-w-4xl grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-5 lg:gap-6">
          <div class="card">
            <div class="flex justify-center p-5">
              <img class="w-9/12" src="images/illustrations/addnewvehicle.svg" alt="image">
            </div>
            <div class="px-4 pb-8 text-center sm:px-5">
              ...
              <a href="add_new_vehicle.php" > <button class="btn mt-8 bg-primary font-medium text-white shadow-lg shadow-primary/50 hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:shadow-accent/50 dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                Add
              </button></a>
              <a href="addbulkform.php" > <button class="btn mt-8 bg-primary font-medium text-white shadow-lg shadow-primary/50 hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:shadow-accent/50 dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                Bulk
              </button></a>
            </div>
          </div>
          <div class="card">
            <div class="flex justify-center p-5">
              <img class="w-9/12" src="images/illustrations/addnewslot.svg" alt="image">
            </div>
            <div class="px-4 pb-8 text-center sm:px-5">
              <h4 class="text-lg font-semibold text-slate-700 dark:text-navy-100">
                Add New Parking Spot
              </h4>
              <a href="addnewspot.php"> <button class="btn mt-8 bg-primary font-medium text-white shadow-lg shadow-primary/50 hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:shadow-accent/50 dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                Add
              </button></a>
              <a href="newdelete_spot.php"> <button class="btn mt-8 bg-primary font-medium text-white shadow-lg shadow-primary/50 hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:shadow-accent/50 dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                Remove
              </button></a>
            </div>
          </div>
          <div class="card">
            <div class="flex justify-center p-5">
              <img class="w-9/12" src="images/illustrations/addacc.svg" alt="image">
            </div>
            <div class="px-4 pb-8 text-center sm:px-5">
              <h4 class="text-lg font-semibold text-slate-700 dark:text-navy-100">
                Add New Account
              ...
              <a <?php if($_SESSION['role'] != 'sadmin'){
                echo 'style="pointer-events: none;
                      color: gray;
                      cursor: not-allowed;"';
              } ?> href="addnewuser.php"> <button class="btn mt-8 bg-primary font-medium text-white shadow-lg shadow-primary/50 hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:shadow-accent/50 dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                Add
              </button></a>
            </div>
          </div>
